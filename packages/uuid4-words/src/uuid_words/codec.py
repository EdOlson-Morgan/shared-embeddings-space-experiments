...
See the package README for usage, and
https://github.com/EdOlson-Morgan/shared-embeddings-space-experiments/blob/main/docs/uuid-token-optimization-plan.md
for the full design rationale and benchmark this package was built from.
"""
